...
namespace SilveR.StatsModels
{
    public class EquivalenceTOSTTestModel : AnalysisDataModelBase
    {
        ...
        public override void LoadArguments(IEnumerable<Argument> arguments)
        {
            ...
            this.LowerBoundAbsolute = argHelper.LoadNullableIntArgument(nameof(LowerBoundAbsolute));
            this.UpperBoundAbsolute = argHelper.LoadNullableIntArgument(nameof(UpperBoundAbsolute));
            this.LowerBoundPercentage = argHelper.LoadNullableIntArgument(nameof(LowerBoundPercentage));
            this.UpperBoundPercentage = argHelper.LoadNullableIntArgument(nameof(UpperBoundPercentage));
